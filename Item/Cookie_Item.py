...
class Cookie_Import_Item():
    ...
    def __init__(self, verticalLayout_list_cookie: QtWidgets.QVBoxLayout,
        ...
        self.groupBox_Cookie_Item = QtWidgets.QGroupBox(
            self.groupBox_list_cookie)
        self.horizontalLayout_cookie_item = QtWidgets.QHBoxLayout(
            self.groupBox_Cookie_Item)
        ...
        self.horizontalLayout_cookie_item.setObjectName(
            "horizontalLayout_cookie_item")
